...
import { Search, GraduationCap, Phone, MapPin, BookOpen, Clock, Calendar, ChevronLeft, ChevronRight, Edit, Trash2 } from 'lucide-react';
import EditTrainingRequestModal from '../components/website/EditTrainingRequestModal';
...
const WebsiteTrainingRequests = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      await deleteDoc(doc(db, 'freequotefromwebsite', selectedRequest.id));
  ...
  return (
    <div className="space-y-6">
      ...
      <DeleteConfirmModal
        ...
        message="Are you sure you want to delete this training request? This action cannot be undone."
      />
    </div>
  );
};
