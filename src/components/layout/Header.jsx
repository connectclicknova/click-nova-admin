  ...
  return (
    <header className="fixed top-0 left-60 right-0 h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 z-10">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="ml-4 flex items-center gap-2 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors border border-red-200 cursor-pointer">
